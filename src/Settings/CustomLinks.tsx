...
const TD = styled.td`
    ...
    white-space: nowrap;
`;
const ManageExistingLinks = memo(() => {
  ...
  return <SettingsContainer>
            <>
                ...
                <ControlGroup>
                    <InputGroup leftIcon="new-text-box" width="180px" onChange={e => setName(e.target.value)} id=" text-input" value={name} placeholder="Name" />
                    <InputGroup leftIcon="link" fill={true} onChange={e => setUrl(e.target.value)} id="text-input" value={url} placeholder="Link" />
          ...
          width: "100%"
              ...
              paddingLeft: "5px"
                        ...
                        {settings.custom_links.length > 0 ? settings.custom_links.map(link => <tr>
                                    <TD style={{
              width: "calc(50% - 20px)"
            }}>
                                        {link.name}
              ...
              width: "40px"
                                        ...
                                        <Icon style={{
                cursor: "pointer"
              }} icon="cross" size={16} onClick={() => delete_item(link)} intent="danger" />
                                    </TD>
                                </tr>) : ""}
                    </tbody>
                </HTMLTable>
