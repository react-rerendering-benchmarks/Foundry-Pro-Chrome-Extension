...
const ProSettingsPopout = memo(() => {
  ...
  let popoverContent = <Box>
            <Popup />
        </Box>;
  return <Container>
            <Popover2 inheritDarkTheme={false} interactionKind={PopoverInteractionKind.CLICK} popoverClassName="bp4-popover-content-sizing" content={popoverContent} position={Position.RIGHT_TOP} minimal={true} usePortal={true} modifiers={{
      preventOverflow: {
        enabled: true
      }
    }}>
